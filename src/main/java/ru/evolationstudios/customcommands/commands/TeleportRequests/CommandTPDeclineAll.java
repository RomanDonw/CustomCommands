...
public final class CommandTPDeclineAll implements CommandExecutor
{
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
        ...
        if (TeleportAccepts.PlayerAvailable(player))
        {
            TeleportAccepts.RemovePlayer(player);
            sender.sendMessage(Config.Message.DeclinedAllRequests);
        }
        else
        {
